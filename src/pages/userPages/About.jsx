    ...
    <section className="w-full bg-black overflow-hidden">
      <div className="flex flex-col lg:flex-row items-center min-h-[550px] max-w-7xl mx-auto">
        ...
        <div className="w-full lg:w-1/2 text-white px-8 lg:px-16 space-y-8 reveal-footer">
          ...
          <button onClick ={() => navigate('/menu')} className="mt-4 px-8 py-3 border border-white text-white rounded-md hover:bg-white hover:text-black transition duration-300">
            Explore Menu
          </button>
        </div>
